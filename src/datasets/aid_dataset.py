...
class AIDDataset:
    def __init__(self, base_dir, extension = "jpg"):
        # self.path_train = self.base_dir + '/AID/images/images_tr'
        # self.path_test = self.base_dir + '/AID/images/images_test'
        # self.labels_path = self.base_dir + '/AID/multilabel.csv'

        super().__init__()
        self.path_train = os.path.join(base_dir, 'images', 'images_tr')
        self.path_test = os.path.join(base_dir, 'images', 'images_test')
        self.labels_path = os.path.join(base_dir, 'multilabel.csv')
